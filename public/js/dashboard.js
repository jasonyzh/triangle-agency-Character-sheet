...
async function loadBranchesForApply() {
    try {
        ...
        container.innerHTML = data.branches.map(function(b) {
            ...
            var btnHtml = joined
                ? '<button disabled style="padding:6px 14px;background:rgba(255,255,255,0.05);color:rgba(255,255,255,0.3);border:1px solid rgba(255,255,255,0.1);border-radius:4px;font-size:12px;font-weight:bold;cursor:not-allowed;">已加入</button>'
