...
function openMissionDetail(missionId) {
    ...
    var right = document.getElementById('mMissionDetail');
    var overlay = document.getElementById('missionDetailOverlay');
    if (right) {
      var wrap = document.getElementById('mgmDetailWrap');
      var empty = document.getElementById('mgmDetailEmpty');
...
function closeMissionDetail() {
    var right = document.getElementById('mMissionDetail');
    var overlay = document.getElementById('missionDetailOverlay');
    if (right) { right.classList.remove('active'); right.style.overflowY = ''; }
        ...
        return `
            <div class="agent-card clickable" data-char-id="${member.character_id}" onclick="openAgentDetail('${member.character_id}')">
                ...
                <div class="agent-actions" onclick="event.stopPropagation()">
                    ...
                    <button class="btn-agent-npc" onclick="openGrantNpcModal('${member.character_id}', '${safeName}')" title="添加关系">
