...
import { loadCharacters, handleSearch, renderCharacters, deleteCharacter, handleSwipe, openSheet, openSlotModal, closeSlotModal, adjustSlot, saveSlots, openRequisitionPermModal, filterRequisitionPerms, closeRequisitionPermModal, saveRequisitionPerms, openDocModal, renderDocList, filterDocs, closeDocModal, saveDocPermissions, openRecordModal, closeRecordModal, switchRecordTab, updateAddButton, loadRecords, renderRecords, addRecord, deleteRecord, openAgentDetail, closeAgentDetailModal } from './characters.js';
...
import { loadAnomalyTemplates, renderAnomalyTemplates, openAnomalyTemplateModal, closeAnomalyTemplateModal, saveAnomalyTemplate, deleteAnomalyTemplate, openGrantAnomalyModal, closeGrantAnomalyModal, saveGrantedAnomalies, grantAnomalyToChar } from './anomaly-templates.js';
