...
// === 异常能力模板 ===
db.run(`CREATE TABLE IF NOT EXISTS anomaly_templates (
    id TEXT PRIMARY KEY,
    branch_id TEXT NOT NULL,
    name TEXT NOT NULL,
    trig TEXT DEFAULT '',
...
// === 图片素材库 ===
db.run(`CREATE TABLE IF NOT EXISTS image_library (
    id TEXT PRIMARY KEY,
...
// 迁移：给 image_library 添加 folder 字段
db.run(`ALTER TABLE image_library ADD COLUMN folder TEXT DEFAULT '默认'`, () => {});

// === 画板 ===
db.run(`CREATE TABLE IF NOT EXISTS mission_boards (
    id TEXT PRIMARY KEY,
    mission_id TEXT NOT NULL,
    name TEXT DEFAULT '',
...
// === 画板图片 ===
db.run(`CREATE TABLE IF NOT EXISTS board_images (
    id TEXT PRIMARY KEY,
...
// === 地图连接线 ===
db.run(`CREATE TABLE IF NOT EXISTS board_connections (
    id TEXT PRIMARY KEY,
    board_id TEXT NOT NULL,
...
// === 玩家 NPC 连线（仅玩家端，4种类型） ===
db.run(`CREATE TABLE IF NOT EXISTS player_npc_connections (
    id TEXT PRIMARY KEY,
    board_id TEXT NOT NULL,
    node_a TEXT NOT NULL,
    node_b TEXT NOT NULL,
