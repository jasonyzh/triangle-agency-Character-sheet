...
router.get('/api/character/:id/check-u2', authenticateToken, (req, res) => {
    try {
        ...
        const perm = db.prepare(`SELECT 1 FROM character_document_permissions WHERE character_id = ? AND LOWER(filename) = 'u2.md'`).get(charId);
